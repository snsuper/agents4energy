...
export const defaultAgents: { [key: string]: defaultAgent } = {
    ProductionAgent: {
        ...
        samplePrompts: [
            ...
            "Execute a SQL query and plot the result to get the total monthly oil, gas, and water production since 1990. Get the table definition so you know what to include in the query."
        ]
    },
    FoundationModel: {
