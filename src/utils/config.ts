...
export const defaultAgents: { [key: string]: defaultAgent } = {
    ProductionAgent: {
        ...
        samplePrompts: [
            ...
            "Execute a SQL query and plot the result to get the average daily oil, gas, and water production over the last 5 years. Get the table definition so you know what to include in the query."
        ]
    },
    FoundationModel: {
