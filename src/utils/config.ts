...
export const defaultAgents: { [key: string]: defaultAgent } = {
    ProductionAgent: {
        ...
        samplePrompts: [
            ...
            "Execute a SQL query and plot the result to get the production over the last 12 weeks. Get the table definition so you know what to include in the query."
        ]
    },
    FoundationModel: {
