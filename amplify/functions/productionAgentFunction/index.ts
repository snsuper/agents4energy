...
import { calculatorTool, wellTableTool, buildConvertPdfToImageTool } from './toolBox';
...
const agentTools = [calculatorTool, wellTableTool, buildConvertPdfToImageTool({s3BucketName: env.DATA_BUCKET_NAME})];
